...
class RVAdapterStraggered(private val source: List<Pair<Int, String>>, private val itemResourceId : Int)
    : RecyclerView.Adapter<RVAdapterStraggered.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(content: Pair<Int, String>) {
            ...
            iv.layoutParams.height = getRandomIntInRange(300, 100)
        }
    }
